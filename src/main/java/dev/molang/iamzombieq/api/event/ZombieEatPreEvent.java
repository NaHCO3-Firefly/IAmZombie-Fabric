 ...
 *
 * <p>The eaten stack is kept as an immutable snapshot ({@link ItemStack#copy()}), so listeners cannot mutate
 * the live stack through it.
 *
 * <p>Part of the STABLE public API surface (semver 1.x).
 */
public final class ZombieEatPreEvent implements ZombieEvent, Cancellable {
